...
### หน้าสร้างโพสต์หาเพื่อนเล่น (Create Post)
ผู้ใช้สามารถสร้างโพสต์เพื่อหาเพื่อนร่วมทีมตามระดับฝีมือและช่วงเวลาที่ต้องการ
<div align="center">
  <img src="./screenshots/create_post.png" alt="Create Post Page" width="100%">
</div>
